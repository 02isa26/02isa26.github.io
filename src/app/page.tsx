          ...
          <div className="mt-10 flex flex-col sm:flex-row">
            <div className="text-center sm:w-1/3 sm:py-8 sm:pr-8">
              <Image
                ...
                alt=""
                priority={true}
                className="mx-auto size-60 rounded-full object-cover"
              />
              <div className="mt-5 flex flex-col items-center justify-center text-center">
                <h2 className="font-title text-5xl font-medium text-white">isa02</h2>
                <div className="mt-4 flex items-center">
                  ...
                  <a
                    ...
                    className="font-geistSans text-lg text-gray-400 hover:underline"
                  >
            ...
            <div className="mt-4 border-t border-gray-800 pt-4 text-left sm:mt-0 sm:w-2/3 sm:border-l sm:border-t-0 sm:py-2 sm:pl-8 sm:text-left">
              <Accordion
                heading="このサイトについて"
                content={
                  <>

        ...
        <section className="text-gray-400 bg-gray-900 body-font">
            <div className="container px-5 py-24 mx-auto flex flex-col">
                <div className="flex flex-col items-center justify-center text-center">
                    <h1 className="title-font sm:text-6xl text-5xl mb-4 font-bold text-white text-center">isa02の個人サイト</h1>
                </div>
                <div className="lg:w-4/6 mx-auto">
                    <div className="flex flex-col sm:flex-row mt-10">
                        <div className="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            <div className="w-20.2 h-20.2 rounded-full inline-flex items-center justify-center bg-gray-800 text-gray-600">
